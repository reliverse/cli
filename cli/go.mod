...
// Commented package lines indicate @blefnk's desire to learn
// them in order to apply them in Reliverse CLI in the future
...
// github.com/microsoft/dev-tunnels v0.1.6
...
// modernc.org/ccgo/v4 v4.9.7 // indirect
