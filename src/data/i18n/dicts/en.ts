...
const dictionary = {
  ...
  pages: {
    "not-found": {
      ...
      description:
        "The resource you're seeking might have been relocated or is not a part of Bleverse Reliverse. Double-check the URL or explore other sections.",
    ...
    home: {
      ...
      subtitle:
        "Bleverse Reliverse simplifies your development journey. Start with built-in features optimized for modern web development.",
      "get-started": "See Starter Features",
      features: {
        title: "Reliverse Starter Features",
        subtitle:
          "From code to design, Reliverse has functionalities that supercharge your web projects.",
        cryptography: {
          title: "Next.js 13",
          description:
      ...
      "open-source": {
        ...
        subtitle: {
          first:
            "Bleverse Reliverse champions open-source ethos and encourages collaborative code evolution.",
    ...
    about: {
      title: "About",
      subtitle:
        "Bleverse Reliverse is a powerful Next.js TypeScript Tailwind starter. It streamlines the development process and provides a solid foundation for creating web projects. Feel free to use, adapt, and contribute to the project by {link}.",
