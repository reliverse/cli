...
import { Combine, Globe, Home, ListMusic, Mic } from "lucide-react";
  ...
  return (
    <MenubarMenu>
      ...
      <MenubarContent>
        ...
        <MenubarLink href="https://reliverse.bleverse.com/">
          Reliverse Next.js Starter
        </MenubarLink>
      </MenubarContent>
    </MenubarMenu>
  );
      ...
      <MenubarContent forceMount>
        <MenubarSub>
          ...
          <MenubarSubContent className="w-[160px] md:w-[180px] lg:w-[200px]">
            <MenubarLink href="https://github.com/blefnk/reliverse" external>
              reliverse
            </MenubarLink>
