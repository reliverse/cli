...
import { configureAppts } from "~/setup/prompt/appts";
import { configureBiome } from "~/setup/prompt/biome";
import { configureEnv } from "~/setup/prompt/envjs";
import { configureEslint } from "~/setup/prompt/eslint";
import { configureKnip } from "~/setup/prompt/knip";
import { configureNext } from "~/setup/prompt/nextjs";
import { configurePutout } from "~/setup/prompt/putout";
