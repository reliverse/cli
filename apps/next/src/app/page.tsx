...
const LINKS = [
	{
		description: "Bootstrap modern web templates much faster than ever.",
		href: "https://github.com/blefnk/reliverse",
		title: "Reliverse builder",
	},
	{
		description:
			"A Next.js e-commerce starter. Highly customizable and scalable.",
		href: "https://github.com/blefnk/relivator-nextjs-template",
		title: "Relivator starter",
	},
	{
	...
	return (
		<main className={styles.main}>
			<div className={styles.description}>
				<p>
					<Code className={styles.code}>blefnk/reliverse</Code>
				</p>
				<div>
					<a
			...
			<div className="flex flex-col items-center gap-2">
				<NextButton appName="web" className={styles.button}>
					Click me! 😀
				</NextButton>
				<HomePageClient />
			</div>
