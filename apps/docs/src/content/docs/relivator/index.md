...
*👉 Read the Detailed Blog Post [About 1.2.6](./v126) and [About 1.3.0@canary](./v130) Update 👈*
...
<p>
  <span>
    <a href="https://github.com/blefnk/relivator-nextjs-template/blob/main/public/reliverse.png">
      <picture>
          <source media="(prefers-color-scheme: dark)" srcset="reliverse.png" />
          <source media="(prefers-color-scheme: light)" srcset="reliverse.png" />
          <img alt="Reliverse" src="reliverse.png" width="35%" />
      </picture>
    </a>
  </span>
</p>
