...
// Run the `bun reli:setup` to easily switch between them and set up other tooling.
  ...
  },
  {
    ...
    rules: {
      ...
      "perfectionist/sort-jsx-props": [
        // TODO: fix (`bun check:eslint`: 14226.536 ms)
        "warn",
        {
          customGroups: {
            id: ["key", "id", "name"],
      ...
      "perfectionist/sort-objects": [
        "warn",
        {
          // TODO: fix (`bun check:eslint`: 61297.924 ms)
          customGroups: {
            _: [
              "_",
              "top",
